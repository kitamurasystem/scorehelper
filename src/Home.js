...
const Home = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Stack, { spacing: 3, sx: { maxWidth: 700, mx: 'auto', mt: 4, p: 2 }, children: [_jsxs(Typography, { variant: "h4", color: "primary", align: "center", children: ["\u753B\u50CF\u30A2\u30C3\u30D7\u30ED\u30FC\u30C9", _jsx("small", { children: "202508211150" })] }), _jsxs(Paper, { elevation: 3, variant: "outlined", sx: {
                            p: 4,
                            textAlign: 'center',
